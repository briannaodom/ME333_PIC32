...
int main(void) {
  ...
  INTCONbits.INT1EP = 1;
  //IPC0bits.INT0IP = 0;
  //IPC0bits.INT0IS = 0;              // step 4: clear 5 priority and subp bits for INT0
  IPC0bits.INT0IP = 6;
  IPC0bits.INT0IS = 0;              // step 4: set INT0 to priority 6 subpriority 0
  //IPC1bits.INT1IP = 0;
  //IPC1bits.INT1IS = 0;              // step 4: clear 5 priority and subp bits for INT1
  IPC1bits.INT1IP = 6;
  IPC1bits.INT1IS = 0;              // step 4: set INT1 to priority 6 subpriority 0
